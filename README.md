[![Android Arsenal](https://img.shields.io/badge/Android%20Arsenal-Context--Menu.Android-brightgreen.svg?style=flat)](https://android-arsenal.com/details/1/1387) [![Yalantis](https://github.com/daniel41nilsen/Context-Menu-android/blob/master/badge.png)](https://yalantis.com/?utm_source=github)
...
### Version: 1.0.5
  ...
  * Fixed `setClosableOutside` [issue](https://github.com/daniel41nilsen/Context-Menu-android/issues/25).
  * Fixed `setAnimationDuration` doesn´t work for open event [issue](https://github.com/daniel41nilsen/Context-Menu-android/issues/22).
  * Fixed menu item listener setting mechanism. It can be not activity but any class that implements listeners now. [Issue](https://github.com/daniel41nilsen/Context-Menu-android/issues/24). Attention! You have to set listeners to the context fragment manually. Check block 5 in the `Usage`.
